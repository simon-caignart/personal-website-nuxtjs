<template>
  <nav class="flex w-full items-center p-5 z-50">
    <!-- Go Back Arrow  -->
    <nuxt-link to="/">
    <svg
    ...
    <!-- Title of the page -->
    <h1
      class="text-white dark:text-gray-800 text-4xl xl:text-5xl font-semibold self-start flex-1 text-center pr-7 xl:pr-10"
    >
      {{ navBarTitle }}
    </h1>
  </nav>
